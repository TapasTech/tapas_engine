...
class SwaggerInfluencerGenerator < Rails::Generators::NamedBase
...
describe '#{chinese_name} API', type: :request, swagger_doc: '#{scope}/golden-funnel-influencer-swagger.json' do
